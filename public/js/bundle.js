...
exports.resetPassword = exports.forgetEmail = exports.signup = exports.logout = exports.login = void 0;
...
var forgetEmail = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Send resetPassword URL successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function forgetEmail(_x7) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Reset Password successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51HzO3NFOqRUkr4yhsBNxP6eLPbhc2GtuCvluj3EVCgnGaaxJ6l8RBnw9cebANQlcM3eeHTYJE4MgKMLiwMd0xrul00ctApP06W');
...
var forgetPasswordForm = document.querySelector('.form--password');
